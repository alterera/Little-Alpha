...
const curriculumSlides = [
  { id: 1, src: "/assets/hero-slide/about/a1.webp", alt: "Curriculum overview" },
  { id: 2, src: "/assets/hero-slide/curriculum/c3.webp", alt: "Learning activities" },
  { id: 3, src: "/assets/hero-slide/in1.webp", alt: "Student engagement" },
];
        ...
        <section className="mt-10 sm:mt-12 lg:mt-16">
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 xl:gap-10 items-center lg:items-start">
            <div className="flex-1 w-full lg:w-auto shrink-0">
              <div className="relative w-full sm:w-64 md:w-72 lg:w-150 h-100 rounded-xl overflow-hidden shadow-lg">
                <Image
                  src={"/assets/hero-slide/in1.webp"}
                  fill
        ...
        <section className="mt-10 sm:mt-12 lg:mt-16 py-8 sm:py-10 lg:py-12 bg-[#EEF7FF] -mx-4 sm:-mx-6 md:-mx-8 lg:-mx-12 xl:-mx-16 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
          <div className="flex flex-col lg:flex-row-reverse gap-6 lg:gap-8 xl:gap-10 items-center lg:items-start">
            <div className="w-full flex-1 lg:w-auto shrink-0">
              <div className="relative w-full sm:w-64 md:w-72 lg:w-180 h-100 rounded-xl overflow-hidden shadow-lg">
                <Image
        ...
        <section className="mt-10 sm:mt-12 lg:mt-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            <div className="md:col-span-2">
              <div className="relative w-full h-150 rounded-xl overflow-hidden shadow-lg">
                <Image
        ...
        <section className="mt-10 sm:mt-12 lg:mt-16 mb-8 sm:mb-12 lg:mb-16">
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 xl:gap-10 items-center lg:items-start">
            <div className="w-full lg:w-auto shrink-0">
              <div className="relative w-full lg:w-96 xl:w-[500px] h-120 rounded-xl overflow-hidden shadow-lg">
                <Image
                  src={"/assets/curriculum/collab.jpg"}
                  fill
