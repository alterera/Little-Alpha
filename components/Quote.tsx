  ...
  return (
    <div className="w-full bg-[#E2EEFF] relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center lg:items-start py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 gap-8 lg:gap-12 xl:gap-16">
        {/* Image - Centered below text on small screens, left side on large screens */}
        <div className="z-10 order-1 lg:order-1">
          <Image
        ...
        {/* Quote Content */}
        <div className="flex items-center relative order-1 lg:order-2 flex-1">
          <Image
            src={"/assets/shapes/quote.svg"}
            height={80}
            width={80}
            alt="quote"
            className="absolute -top-12 -left-3 sm:-top-5 sm:-left-10 w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 opacity-50"
          />
          <Image
            src={"/assets/shapes/quote.svg"}
            height={80}
